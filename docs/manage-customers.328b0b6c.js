...
},{}],"ts/manage-customers.ts":[function(require,module,exports) {
"use strict";
...
var pagination_1 = require("./pagination"); // const BASE_API = 'https://bc677221-4831-4411-b038-9e174414f8ff.mock.pstmn.io';


var BASE_API = "http://localhost:8080/pos";
var CUSTOMERS_SERVICE_API = BASE_API + "/customers";
var PAGE_SIZE = 6;
var PAGINATION = new pagination_1.Pagination((0, jquery_1.default)(".pagination"), PAGE_SIZE, 0, loadAllCustomers);
var customers = [];
...
(0, jquery_1.default)("#btn-save").on("click", function (eventData) {
  ...
  if (txtId.attr("disabled")) {
    ...
    updateCustomer(new customer_1.Customer(id, name, address));
    return;
  }
...
function loadAllCustomers() {
  fetch(CUSTOMERS_SERVICE_API + "?" + new URLSearchParams({
...
function deleteCustomer(id) {
  fetch(CUSTOMERS_SERVICE_API + ("?" + new URLSearchParams({
    ...
    if (response.status !== 204) throw new Error("Failed to delete the customer, try again");
    totalCustomers--;
    PAGINATION.pageCount = Math.ceil(totalCustomers / PAGE_SIZE);
    PAGINATION.navigateToPage(PAGINATION.pageCount);
...
},{"./dto/customer":"ts/dto/customer.ts","jquery":"node_modules/jquery/dist/jquery.js","./pagination":"ts/pagination.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","ts/manage-customers.ts"], null)
//# sourceMappingURL=/manage-customers.328b0b6c.js.map